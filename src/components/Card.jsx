    ...
    >
      ...
      <div className="mb-4">
        ...
        {document.description && (
          <p className="text-xs text-gray-500 line-clamp-2 mt-1">{document.description}</p>
        )}
      </div>
...
// Stats Card Variant
export const StatsCard = ({ title, value, subtitle, icon, trend, className = '' }) => {
...
// Empty State Card
export const EmptyStateCard = ({ title, description, icon, action, className = '' }) => (
