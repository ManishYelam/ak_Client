...
import { faCopy, faQrcode, faMobileScreen, faCheckCircle } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6 max-w-md mx-auto">
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6 border border-gray-100">
        <div className="flex flex-col items-center">
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-4">
            <img src={upiimg} alt="UPI QR Code" className="mx-auto w-48 h-48 object-contain" />
          </div>
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-2 bg-white border border-gray-300 rounded-lg px-4 py-3">
            <span className="font-mono text-lg font-bold text-gray-800">{upiId}</span>
            <button
            ...
            {upiInstructions.map((instruction, index) => (
              <div key={index} className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mt-0.5">
                  <FontAwesomeIcon icon={instruction.icon} className="text-blue-600 text-xs" />
                </div>
      ...
      <div className="mt-4 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
        <p className="text-xs text-yellow-800 text-center">
          💡 <strong>Important:</strong> After payment, don't forget to save the transaction ID and
