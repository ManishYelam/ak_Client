  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className={`p-1 border rounded text-[10px] ${getFieldBorderClass('full_name')} ${
              getInputDisabled('full_name') ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''
            }`}
            required
          />
          ...
          <input
            ...
            className={`p-1 border rounded text-[10px] ${getFieldBorderClass('date_of_birth')} ${
              getInputDisabled('date_of_birth') ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''
            }`}
            required
          />
          ...
          <input
            ...
            className={`p-1 border rounded text-[10px] ${getFieldBorderClass('age')} ${
              getInputDisabled('age') ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''
            }`}
            min="1"
            max="120"
            required
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className={`p-1 border rounded text-[10px] ${getFieldBorderClass('phone_number')} ${
              getInputDisabled('phone_number') ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''
            }`}
            pattern="[0-9]{10}"
            required
          />
          ...
          <input
            ...
            className={`p-1 border rounded text-[10px] ${getFieldBorderClass('email')} ${
              getInputDisabled('email') || mode === 'edit'
          ...
          <select
            ...
            className={`p-1 border rounded text-[10px] ${getFieldBorderClass('gender')} ${
              getInputDisabled('gender') ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''
            }`}
            required
          >
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className={`p-1 border rounded text-[10px] ${getFieldBorderClass('occupation')} ${
              getInputDisabled('occupation') ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''
            }`}
            required
          />
          ...
          <input
            ...
            className={`p-1 border rounded text-[10px] ${getFieldBorderClass('adhar_number')} ${
              getInputDisabled('adhar_number') ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''
            }`}
            pattern="[0-9]{12}"
            required
          />
          ...
          <textarea
            ...
            className={`p-1 border rounded text-[10px] resize-none ${getFieldBorderClass('address')} ${
              getInputDisabled('address') ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''
            }`}
            rows={2}
            required
          />
        ...
        <div className="md:col-span-3 flex flex-col">
          ...
          <textarea
            ...
            className={`p-1 border rounded text-[10px] resize-none ${getFieldBorderClass('additional_notes')} ${
              getInputDisabled('additional_notes')
                ? 'bg-gray-50 text-gray-600 cursor-not-allowed'
                : ''
            }`}
            rows={2}
      ...
      <div className="mt-4 p-2 bg-gray-100 rounded text-[8px] text-gray-600">
        ...
        Valid: {isFormValid ? 'Yes' : 'No'} | Has Data: {formData.full_name ? 'Yes' : 'No'} | DOB:{' '}
        {formData.date_of_birth || 'Empty'} | Age: {formData.age || 'Empty'}
      </div>
      ...
      <div className="flex justify-end mt-3">
        <button
          ...
          className={`px-3 py-1 text-white rounded text-[10px] transition-colors flex items-center gap-2 ${
            mode !== 'view' && (!isFormValid || isCheckingEmail || isLoading)
