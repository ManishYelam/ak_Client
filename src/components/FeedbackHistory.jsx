      ...
      if (response.success && response.data) {
        ...
        setPagination(prev => ({
          ...
          pages:
            ...
            Math.ceil((paginationData.totalItems || feedbackData.length) / pagination.limit),
        }))
      } else {
    ...
    return (
      <div className="flex items-center gap-1">
        {[...Array(5)].map((_, i) => (
          <FaStar
            key={i}
            className={`text-sm ${i < rating ? 'text-yellow-500 fill-current' : 'text-gray-300'}`}
          />
        ))}
        ...
        {feedback.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-500 mb-6 max-w-md mx-auto">
              Your feedback helps us improve the system. Share your thoughts and suggestions to help
              us serve you better.
            </p>
            <Link
              to="/"
              ...
              <div className="p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <span
                      className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getCategoryColor(item.category)}`}
                    >
