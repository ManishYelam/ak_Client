    ...
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      >
        <span className="truncate">
          {value.filterType ? formatDateForDisplay(value.filterType, value.value) : placeholder}
        </span>
        <FaCalendarAlt
          size={size === 'sm' ? 10 : 12}
        ...
        <div className="absolute top-full left-0 mt-1 bg-white border border-gray-300 rounded shadow-lg z-50 min-w-[200px] max-w-[280px]">
          ...
          <div className="p-2 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <span
                className={`font-semibold text-gray-700 ${size === 'sm' ? 'text-[8px]' : 'text-[9px]'}`}
              >
                Date Filters
              </span>
              {value.filterType && (
          ...
          <div className="max-h-60 overflow-y-auto">
            ...
            <div className="p-2">
              <div
                className={`font-semibold text-gray-500 mb-1 ${size === 'sm' ? 'text-[7px]' : 'text-[8px]'}`}
              >
                QUICK FILTERS
              </div>
                ...
                {value.filterType === 'date_range' && (
                  <div className="mt-1 px-2 space-y-1">
                    <div className="flex items-center gap-1">
                      <span
                        className={`text-gray-600 ${size === 'sm' ? 'text-[7px] w-10' : 'text-[8px] w-12'}`}
                      >
                        From:
                      </span>
                      <input
