  ...
  <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      {actions.map((action, index) => (
        ...
        >
          <div
            className={`w-12 h-12 ${action.bgColor} rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform`}
          >
...
const AdminDashboard = () => {
  ...
  const { overview, recent_enrollments, course_performance, system_health, realTime, system } =
    dashboardData || {}
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                ...
                <span className="font-medium">
                  System: {system_health?.server_uptime || '99.9%'} Uptime
                </span>
              </div>
              <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div
                className={`p-3 rounded-xl ${stat.bgColor} transition-transform duration-300 hover:scale-110`}
              >
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            {course_performance?.slice(0, 5).map((course, index) => (
              <div
                key={course.id}
                className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:border-primary-300 transition-colors duration-200"
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {course.enrollment_count} enrollments • {Math.round(course.avg_progress)}% avg
                      progress
                    </p>
                  </div>
                </div>
