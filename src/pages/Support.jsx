            ...
            <div className="mb-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-xl">
                  ...
                  <div className="mt-4 text-blue-100 text-sm">All support requests</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl p-6 text-white shadow-xl">
                  ...
                  <div className="mt-4 text-amber-100 text-sm">Awaiting resolution</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-xl">
                  ...
                  <div className="mt-4 text-orange-100 text-sm">Being worked on</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-6 text-white shadow-xl">
                  ...
                  <div className="mt-4 text-emerald-100 text-sm">Completed tickets</div>
                </div>
              </div>
            </div>
          )}
    ...
    <div className="p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {CONTACT_METHODS.map((method, index) => {
          ...
          return <ContactMethod key={index} method={method} IconComponent={IconComponent} />
        })}
      </div>
      ...
      <select
        ...
        className={`w-full px-4 py-3 border text-sm rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 ${
          error
            ...
            : 'border-gray-300 hover:border-gray-400 focus:shadow-xs'
        }`}
      >
        {options.map(opt => (
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {faqs.length > 0 ? (
            ...
            <EmptyState message="No FAQs available at the moment." icon={FaQuestionCircle} />
          )}
        </div>
      )}
    </div>
...
const FaqItem = ({ item, isExpanded, onToggle }) => (
  <div className="border border-gray-200 rounded-xl overflow-hidden transition-all duration-200 hover:shadow-md bg-white">
    ...
    >
      ...
      <div
        className={`text-gray-400 flex-shrink-0 transition-transform duration-200 group-hover:text-green-500 ${
    ...
    <div className="border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-200 bg-white group hover:border-green-200">
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex flex-col gap-2 flex-shrink-0 ml-3">
          ...
          <span
            className={`px-3 py-1.5 rounded-full text-xs font-semibold border ${priorityConfig.color} flex items-center gap-1.5`}
          >
...
const TicketListItem = ({ ticket }) => {
  ...
  return (
    <tr className="hover:bg-gray-50/50 transition-colors group">
      <td className="px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500 mt-1">#{ticket.ticket_number}</div>
          </div>
        </div>
      </td>
      <td className="px-6 py-4">
        <span
          className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold ${statusConfig.color} border`}
        >
          {statusConfig.label}
        </span>
      </td>
      <td className="px-6 py-4">
        <span
          className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold ${priorityConfig.color} border`}
        >
          {priorityConfig.label}
        </span>
      </td>
