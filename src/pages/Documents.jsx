...
const Documents = () => {
  ...
  const handleFavorite = id => {
    setDocuments(documents.map(doc => (doc.id === id ? { ...doc, favorite: !doc.favorite } : doc)))
  }
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex gap-1">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium border ${getStatusColor(doc.status)}`}
                    >
                      {doc.status}
                    </span>
                  </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <Card className="max-w-md w-full p-6">
              ...
              <div className="flex gap-3 justify-end">
                ...
                <Button onClick={() => fileInputRef.current?.click()} disabled={uploadProgress > 0}>
                  Select Files
                </Button>
              </div>
            </Card>
