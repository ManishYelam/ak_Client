...
const NotificationsPage = () => {
  ...
  const filters = [
    ...
    {
      key: NOTIFICATION_TYPES.CASE_UPDATE,
      label: 'Case Updates',
      count: notifications.filter(n => n.type === NOTIFICATION_TYPES.CASE_UPDATE).length,
    },
    {
      key: NOTIFICATION_TYPES.PAYMENT,
      label: 'Payments',
      count: notifications.filter(n => n.type === NOTIFICATION_TYPES.PAYMENT).length,
    },
    {
      key: NOTIFICATION_TYPES.DOCUMENT,
      label: 'Documents',
      count: notifications.filter(n => n.type === NOTIFICATION_TYPES.DOCUMENT).length,
    },
    {
      key: NOTIFICATION_TYPES.REMINDER,
      label: 'Reminders',
      count: notifications.filter(n => n.type === NOTIFICATION_TYPES.REMINDER).length,
    },
  ]
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Stay updated with your legal practice activities</p>
            </div>
