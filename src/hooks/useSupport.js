...
import {
  supportValidationSchemas,
  formatSupportData,
} from '../hooks/YupValidations/supportValidation'
    ...
    async ticketData => {
      ...
      try {
        ...
        if (
          ...
          errorMessage.includes('case_id')
        ) {
          errorMessage =
            'The provided Case ID does not exist. Please check the Case ID or leave it empty if not related to a case.'
        }
